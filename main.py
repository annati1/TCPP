...
XP: {fix_num(data['xp'])}\n\n
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[FFB300][b][c]MADE BY BISHALCDX YT
            """
            return msg
        else:
            msg = """
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]BISHALCDX YT [00FF00]!!
"""
...
[b][i][FFC0CB]Youtube: BISHALCDX[/b]

[b][i][FFC0CB]Instagram: whos_twins

[b][c][FFC0CB]Subcribe: BISHALCDX[FFFFFF]
 
[b][i][FFA500]Telegram: @NAHI BATAUNGA❤️[/b]

[b][c][FFA500]Telegram contact: @BISHALCDX[A52A2A]
 
Enjoy the bishal bot my friend.......

[C][B][0000FF] Created by BISHALCDX 
Modified by - BSL
"""
                        ...
                        if inPuTMsG.strip().lower() in ("op", "/BISHAL", "hi", "/help"):
...
[FFFFFF]Welcome to bishal Bot
[C][B][FF0000]━━━━ MENU 1 ━━━━

[C][B][FFFF00]🎮 Basic Commands • Premium Setup

[B][C][FFFFFF]/3               [00FF00]- Create 3P Group ⚡
[B][C][FFFFFF]/5               [00FF00]- Create 5P Group 🔥
[B][C][FFFFFF]/6               [00FF00]- Create 6P Group 🚀

[B][C][FFFFFF]/inv uid         [00FF00]- Quick Invite 🎯
[B][C][FFFFFF]/join code       [00FF00]- Fast Join 🔗
[B][C][FFFFFF]/exit            [00FF00]- Leave Group ❌
[B][C][FFFFFF]/s               [00FF00]- Start Match ▶️

[B][C][FFFFFF]/r code uid emoteid   [00FF00]- No Detect Mode 🛡️ 
...
[00FFFF]━━━━━━━━━━━━'''
                        ...
                        elif inPuTMsG.strip().lower() in ("menu2", "/menu2", "next", "2"):
                            menu2 = '''[C][B][FF0000]━━━━ MENU 2 ━━━━
[C][B][FFFF00]⚡ Advanced Commands:
[B][C][FFFFFF]/spm_inv uid [00FF00]- Spam Invite
[B][C][FFFFFF]/stop spm_inv [00FF00]- Stop
...
[C][B][FFFF00]Type "menu3" for next page'''
                        ...
                        elif inPuTMsG.strip().lower() in ("menu3", "/menu3", "next2", "3"):
                            menu3 = f'''[C][B][FF0000]━━━━ MENU 3 ━━━━
[C][B][FFFF00]😎 Emote Commands:
[B][C][FFFFFF]/e uid emoteid [00FF00]- Emote
[B][C][FFFFFF]/fast uid emoteid [00FF00]- Fast (25x)
...
[FFFFFF]🤖 Bot Name: [00FF00]{LoGinDaTaUncRypTinG.AccountName if hasattr(LoGinDaTaUncRypTinG, 'AccountName') else 'BISHAL Bot'}
...
[C][B][FFB300]👑 Developed by: BISHALCDX
[00FF00]━━━━━━━━━━━━"""
...
async def MaiiiinE():
    ...
    Uid , Pw = '4290976023','BISHAL_3QMHQ_U4EIA'
